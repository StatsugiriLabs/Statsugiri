...
def test_to_dict_happy_path():
    snapshot = ReplaySnapshot("2022-01-01", "test_format", [
    ...
    expected_json = {
        ...
        "replay_list": [
            {
                "id": 1, "username": "user1", "rating": 1001, "format": "test_format", 
                "log": "log1", "upload_date": "2022-01-01"
            },
            {
                "id": 2, "username": "user2", "rating": 1002, "format": "test_format", 
                "log": "log2", "upload_date": "2022-01-02"
            }
        ]
    }
